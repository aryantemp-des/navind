...
export const ASSISTANT_PAGE_REGISTRY: AssistantPageItem[] = [
  ...
  },
  {
    ...
    route: "/pricing/india",
    description: "Fixed Indian Rupee packages (₹10,000 / ₹1,19,000) with GST invoices and local UPI/NEFT support.",
    category: "pricing",
  ...
  // --- STRATEGIC GEO HUBS ---
  {
    ...
    description: "Enterprise web development across India. Fixed ₹10,000 + GST packages, local UPI/Razorpay, and full GST billing.",
    category: "geo",
